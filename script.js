/* =============================================
   Raj Gowrising — Portfolio Behavior
   Handles scroll reveals + animated
   network-node background in the hero.
   ============================================= */
...
document.querySelectorAll('.tl-card, .exp-cell, .edu-row, .int-card, .stat-row').forEach(el=>{
